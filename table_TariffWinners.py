...
if __name__ == '__main__':
    ...
    print("""Define 'Low income' as household income per capita per month lower than 400 kVND
in rural area, 500 kVND in urban areas (official definition in 09-2011/QD-TTg)""")

    print()
    print("Household category         \tWinners     \tIndifferent   \tLoosers   \t# Households")

    print("Paid for <30kWh            \t", impact_categories('elec_last_month <= 29.79'))
    ...
    print("High cost & officialy poor \t", impact_categories('inc_pov == "Yes" and high_cost'))
    print("High cost & low income     \t", impact_categories('low_income and high_cost'))

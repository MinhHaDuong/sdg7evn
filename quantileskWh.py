...
print()
print('Half of the self-declared electricity poors households used less than')
print(medPoor, 'kWh in the month')
print('That is', numPoor, 'respondents')

p = percentileofscore(e, medPoor)
numSober = round(p * len(e)/100)
print('\n', p, 'percent of respondents used less than', medPoor, 'kWh/month')
...
print('For one who declares lacking electricity,',
      odd,
      'declare having enough')
